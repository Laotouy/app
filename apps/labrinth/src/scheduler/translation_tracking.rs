...
本汉化包内置 BBSMC 合作面板服务器销售广告，广告仅会出现在服务器多人游戏列表和单人游戏创建世界的导航页面中，**不会影响游戏内体验**。

游戏内如有任何汉化质量问题，欢迎前往 QQ 群反馈，我们将及时校准并重新发布修改后的汉化包。

> 如果不想展示广告，可删除汉化补丁 mods 文件夹内的 **YTGame-HostingMenu** 模组，但删除后将**无法自动加载汉化资源包**和**自动设置客户端语言**，需要手动操作。"#
}
