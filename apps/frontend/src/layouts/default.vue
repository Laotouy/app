      ...
      <div class="header-container">
        ...
        <nav class="header-nav">
          ...
          <NuxtLink
            to="/plugins"
            class="nav-link"
            :class="{ active: route.name === 'search-plugins' || route.path.startsWith('/plugin/') }"
          >
          ...
          <div class="nav-more">
            ...
            <div class="nav-more-dropdown">
              ...
              <NuxtLink to="/softwares" class="dropdown-link">
      ...
      <div class="footer-container">
        ...
        <div class="footer-brand">
          ...
          <div class="footer-social">
            ...
            <a href="https://space.bilibili.com/your-channel" target="_blank" rel="noopener" class="social-link">
              <svg viewBox="0 0 24 24" fill="currentColor" class="social-icon">
